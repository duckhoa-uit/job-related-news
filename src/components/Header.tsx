          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                <MobileNavItem href="/articles/create">
                  Create Article
                </MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/articles/create">Create Article</NavItem>
...
function AvatarContainer({ className = '', ...props }) {
  return (
    <div
      className={clsx(
        className,
        'h-16 w-44 bg-white/90 p-0.5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10'
      )}
      {...props}
    />
  )
...
function HeaderLogo({ large = false, className = '', ...props }) {
  return (
    <Link
      href="/"
      aria-label="Home"
    ...
    >
      <Image
        ...
        className={clsx(
          'object-fill dark:bg-zinc-800',
          large ? 'h-16 w-44' : 'h-9 w-9'
        )}
        priority
        fill
      />
